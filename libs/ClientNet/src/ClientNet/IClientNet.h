...
public:
    ...
    virtual bool Login(LPCSTR lpString, LPCSTR lpPassword, char shardId, char channel) = 0;
    virtual void Func_6() = 0;
    virtual void Func_7() = 0;
    virtual void Func_8() = 0;
    virtual CMsg* AllocMessage(WORD wMsgId, int bEncrypted) = 0;
    ...
    virtual void FreeMsg(CMsg* pMsg) = 0;
